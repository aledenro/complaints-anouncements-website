...
-- distrito por canton y provincia SAN JOSE
...
VALUES 
('Juan', 'Pérez García', 'juan.perez@example.com', '555-1234', TRUE, 'password123', 'usuario'),
('María', 'López Fernández', 'maria.lopez@example.com', '555-5678', TRUE, 'securePass!', 'usuario'),
('Carlos', 'Gómez Martínez', 'carlos.gomez@example.com', '555-8765', TRUE, 'myPassword@2024', 'usuario'),
('Ana', 'Ruiz Sánchez', 'ana.ruiz@example.com', '555-4321', TRUE, 'anaSecure456', 'usuario'),
('Luis', 'Martínez Herrera', 'luis.martinez@example.com', '555-1357', FALSE, 'luisPass789', 'usuario'),
('Admin', 'Admin', 'admin@gmail.com', '1111-1111', FALSE, '$2y$10$4ibFmNkT0J89tgDNYKQ7VeH07bYTT02Anqt1fN1lRLgZTlXI7Wa6O', 'admin');

INSERT INTO Categoria_Anuncio (nombre) VALUES
('Servicios Públicos'),
